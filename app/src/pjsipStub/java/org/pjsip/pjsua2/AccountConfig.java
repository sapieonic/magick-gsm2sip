...
public class AccountConfig {
    public String idUri = "";
    public AccountRegConfig regConfig = new AccountRegConfig();
    public AccountSipConfig sipConfig = new AccountSipConfig();
    public AccountNatConfig natConfig = new AccountNatConfig();
